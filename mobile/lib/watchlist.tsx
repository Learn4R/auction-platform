...
// Mirrors client/src/lib/watchlist.tsx exactly — a set of watchlisted item
// ids (not full items; the Watchlist tab fetches full ItemSummary objects
// itself) so WatchlistButton anywhere in the app (Home, Auctions, Item
// Detail, Live Auction) can show the right heart state instantly, with an
// optimistic toggle corrected if the server call fails.
