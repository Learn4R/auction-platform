...
/**
 * Shared data + socket + bidding logic for a single item/auction, used by
 * both the regular item detail page and the dedicated live auction page so
 * neither reimplements the Socket.io wiring or bid/max-bid flow.
 */
